                      ...
                      <tr key={batch.id}>
                        ...
                        <td>
                          <div className="batch-file-cell">
                            ...
                            {batch.importSource === "auto" && <span className="badge auto-upload" style={{ fontSize: "0.65rem", padding: "2px 6px" }}>Auto-upload</span>}
                          </div>
                        </td>
            ...
            {!drawerLoading && !drawerError && drawerData && (
              <>
                <div className="bottom-sheet-section">
                  <h4 className="section-title" style={{ fontSize: "0.95rem", marginBottom: 8 }}>Riepilogo Dati Batch</h4>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px 24px", fontSize: "0.82rem", background: "rgba(255,255,255,0.02)", padding: "16px", borderRadius: "12px", border: "1px solid var(--md-outline-variant)" }}>
                    <div>
                      <span style={{ color: "var(--color-text-muted)" }}>File Sorgente:</span>
                    ...
                    <div>
                      ...
                      <p style={{ margin: "4px 0 0" }}>
                        {drawerData.importSource === "auto" ? (
                          ...
                          <span className="badge secondary">Upload Manuale Web</span>
                        )}
                      </p>
                    </div>
                    <div>
                      <span style={{ color: "var(--color-text-muted)" }}>Totale Ordini Caricati:</span>
                ...
                <div className="bottom-sheet-section">
                  ...
                  {drawerData.errors?.length === 0 ? (
                    <p style={{ fontSize: "0.8rem", color: "var(--color-text-muted)", margin: 0 }}>Nessun errore registrato in questo batch.</p>
                  ) : (
